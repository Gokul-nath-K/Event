...
const Plans = () => {
  return (
    <>
                <section className="flex items-center justify-center mt-5 pb-10">
  <div className="p-4 sm:px-10 flex flex-col justify-center items-center text-base h-100vh mx-auto" id="pricing">
    ...
    <div className="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div className="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
        ...
        <p className="mt-4 text-base leading-6 text-gray-600">1 license for only 1 activation</p>
        <p className="mt-6 flex items-baseline gap-x-1">
          <span className="line-through text-2xl font-sans text-gray-500/70">$39</span><span className="text-5xl font-bold tracking-tight text-gray-900">$29</span>
        </p>
        <Link to="/payment" state={{plan : "Basic"}} href aria-describedby="tier-standard" className="text-blue-600 ring-1 ring-inset ring-blue-200 hover:ring-blue-300 mt-6 block rounded-md py-2 px-3 text-center text-base font-medium leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Buy now</Link>
      ...
      <div className="ring-2 ring-blue-600 rounded-3xl p-8 xl:p-10">
        <div className="flex items-center justify-between gap-x-4">
          <h3 id="tier-extended" className="text-blue-600 text-2xl font-semibold leading-8">Extended</h3>
          <p className="rounded-full bg-blue-600/10 px-2.5 py-1 text-xs font-semibold leading-5 text-blue-600">
            Most popular</p>
        </div>
        <p className="mt-4 text-base leading-6 text-gray-600">1 license for up to 3 activations</p>
        <p className="mt-6 flex items-baseline gap-x-1">
