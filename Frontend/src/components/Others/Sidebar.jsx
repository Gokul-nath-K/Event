  ...
  return (
    <>
      <div className="relative ">
        ...
        <aside
          id="logo-sidebar"
          className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 border border-gray-300 transition-transform -translate-x-full bg-white border-r text-black  sm:translate-x-0 0"
          aria-label="Sidebar"
        >
