...
const cakesData = [
  ...
  {
    image: 'https://i.pinimg.com/564x/fc/19/21/fc1921c0df157aea7a1a4c0f8e33d3ec.jpg',
    name:'',
...
function GoldenPackageMarriage() {
  return (
    <div className="golden-packageqq">
      {/* <HomeNavbar/> */}
      ...
      <section className="package-includes">
        ...
        <h3 className='tamount'>Cost-Rs 1,68,999-1,99,999/-<span className='hhii'>(price varies based on decorations)</span></h3> 
       <Link to="/weddingform"> < button className='hiking'>Purchase </button> </Link><span className='hhiii'>Make a booking payment of ₹10000 in advance</span>
        <p className='bitto'>   Gold wedding package includes mandap, car decoration, stage decoration, passage decoration, home decoration, entrance, flower booth. Dream Maker provides the best wedding decoration service on India.</p>
